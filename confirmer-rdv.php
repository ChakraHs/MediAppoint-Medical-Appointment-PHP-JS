...
if ( empty($_POST['nom']) || empty($_POST['prenom']) || empty($_POST['adresse']) || empty($_POST['email']) || empty($_POST['tele']) || empty($_POST['nom-utilisateur']) || empty($_POST['mdp']) || empty($_POST['mdps']) ) {
