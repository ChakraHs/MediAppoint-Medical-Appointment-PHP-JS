...
/*$pagecolor = 'white';//par defaut
if(isset($_POST["rpc"])){
    $pageform = $_POST["rpc"];
    setcookie("pc",$pageform);
}else if($_COOKIE['pc']){
    $pagecolor = $_COOKIE['pc'];
}
...
<head>
    ...
    <link href="css/hero-bottom.css" rel="stylesheet">
    <link href="css/bar-bottom.css" rel="stylesheet">
    <link href="css/hero-buttom2.css" rel="stylesheet">
    <link href="css/navbar.css" rel="stylesheet">


    <script src="https://kit.fontawesome.com/e2cb0b37a6.js" crossorigin="anonymous"></script>
...
<body>
    ...
    <section class="hero">
        <div class="content">
            <form onsubmit="required()" name="formRdvSearch">
                    ...
                    <table>
                        <tr>
                            <td colspan="3">
                                <div class="btns-title">
                                    <center>
                                        <h1 >Choisez le type de consultation</h1>
                                    </center>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <center>
                                    <label>
                                    <input type="radio" name="rad" id="" value="A domicile" onclick="img(1)" <?php if($_SESSION['rad-d'] == 'checked') echo 'checked ='.$_SESSION['rad-d']; ?> >
...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 229.957 229.957" style="enable-background:new 0 0 229.957 229.957;" xml:space="preserve">
            ...
            <div class="content-choice-img">
                <img src="img/choice.png" alt="" width="150">
            </div>
            ...
            <div class="input1 inputs" id="input1" style="display: <?php echo $_SESSION['form-d']; ?>;">
                ...
                <div class="box">
                    ...
                    <input type="text" placeholder="Tapez un symptôme, une spécialité" name="specialiteD" list = "spdac">
                ...
                <div class="box">
                    ...
                    <input type="text" placeholder="Centre" name="centreD">
                </div>
                <div class="box">
            ...
            <div class="input2 inputs" id="input2" style="display: <?php echo $_SESSION['form-a']; ?>;">
                ...
                <div class="box">
                    ...
                    <input type="text" placeholder="Tapez un symptôme, une spécialité" name="specialiteA" list = "spdac">
                </div>
                <div class="box">
                    <label class="text-avant-input">
                        <svg class="svg-input" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M61,20H48V3a1,1,0,0,0-1-1H17a1,1,0,0,0-1,1V20H3a1,1,0,0,0-1,1V61a1,1,0,0,0,1,1H61a1,1,0,0,0,1-1V21A1,1,0,0,0,61,20ZM4,22H16V60H4ZM35,50V60H29V50ZM46,60H37V50h2V48H25v2h2V60H18V4H46Zm14,0H48V22H60Z"/><path d="M51,32h6a1,1,0,0,0,1-1V25a1,1,0,0,0-1-1H51a1,1,0,0,0-1,1v6A1,1,0,0,0,51,32Zm1-6h4v4H52Z"/><path d="M51,42h6a1,1,0,0,0,1-1V35a1,1,0,0,0-1-1H51a1,1,0,0,0-1,1v6A1,1,0,0,0,51,42Zm1-6h4v4H52Z"/><path d="M51,52h6a1,1,0,0,0,1-1V45a1,1,0,0,0-1-1H51a1,1,0,0,0-1,1v6A1,1,0,0,0,51,52Zm1-6h4v4H52Z"/><path d="M13,24H7a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h6a1,1,0,0,0,1-1V25A1,1,0,0,0,13,24Zm-1,6H8V26h4Z"/><path d="M21,28h4a1,1,0,0,0,1-1V23a1,1,0,0,0-1-1H21a1,1,0,0,0-1,1v4A1,1,0,0,0,21,28Zm1-4h2v2H22Z"/><path d="M34,22H30a1,1,0,0,0-1,1v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V23A1,1,0,0,0,34,22Zm-1,4H31V24h2Z"/><path d="M38,23v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V23a1,1,0,0,0-1-1H39A1,1,0,0,0,38,23Zm2,1h2v2H40Z"/><path d="M21,36h4a1,1,0,0,0,1-1V31a1,1,0,0,0-1-1H21a1,1,0,0,0-1,1v4A1,1,0,0,0,21,36Zm1-4h2v2H22Z"/><path d="M34,30H30a1,1,0,0,0-1,1v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V31A1,1,0,0,0,34,30Zm-1,4H31V32h2Z"/><path d="M43,30H39a1,1,0,0,0-1,1v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V31A1,1,0,0,0,43,30Zm-1,4H40V32h2Z"/><path d="M21,44h4a1,1,0,0,0,1-1V39a1,1,0,0,0-1-1H21a1,1,0,0,0-1,1v4A1,1,0,0,0,21,44Zm1-4h2v2H22Z"/><path d="M34,38H30a1,1,0,0,0-1,1v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V39A1,1,0,0,0,34,38Zm-1,4H31V40h2Z"/><path d="M43,38H39a1,1,0,0,0-1,1v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V39A1,1,0,0,0,43,38Zm-1,4H40V40h2Z"/><path d="M13,34H7a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h6a1,1,0,0,0,1-1V35A1,1,0,0,0,13,34Zm-1,6H8V36h4Z"/><path d="M13,44H7a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h6a1,1,0,0,0,1-1V45A1,1,0,0,0,13,44Zm-1,6H8V46h4Z"/><path d="M26,16h3v3a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V16h3a1,1,0,0,0,1-1V11a1,1,0,0,0-1-1H35V7a1,1,0,0,0-1-1H30a1,1,0,0,0-1,1v3H26a1,1,0,0,0-1,1v4A1,1,0,0,0,26,16Zm1-4h3a1,1,0,0,0,1-1V8h2v3a1,1,0,0,0,1,1h3v2H34a1,1,0,0,0-1,1v3H31V15a1,1,0,0,0-1-1H27Z"/><rect height="2" width="2" x="42" y="56"/><rect height="2" width="2" x="42" y="52"/><rect height="2" width="2" x="42" y="48"/></svg>
                    </label>
                    <input type="text" placeholder="Centre" name="centreA">
                </div>
                <div class="box">
                    <label class="text-avant-input"><svg class="svg-input" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1.5em" height="1.5em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"><g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="16" cy="11" r="4"/><path d="M24 15c-3 7-8 15-8 15s-5-8-8-15s2-13 8-13s11 6 8 13Z"/></g></svg></label>
                    <input type="text" placeholder="Ville ou code postal" name="ville">
            ...
            <div class="input3 inputs" id="input3" style="display: <?php echo $_SESSION['form-c']; ?>;">
                ...
                <div class="box">
                    ...
                    <input type="text" placeholder="Tapez un symptôme, une spécialité" name="specialiteC" list = "spdac">
                </div>
                <div class="box">
                    <label class="text-avant-input">
                        <svg class="svg-input" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M61,20H48V3a1,1,0,0,0-1-1H17a1,1,0,0,0-1,1V20H3a1,1,0,0,0-1,1V61a1,1,0,0,0,1,1H61a1,1,0,0,0,1-1V21A1,1,0,0,0,61,20ZM4,22H16V60H4ZM35,50V60H29V50ZM46,60H37V50h2V48H25v2h2V60H18V4H46Zm14,0H48V22H60Z"/><path d="M51,32h6a1,1,0,0,0,1-1V25a1,1,0,0,0-1-1H51a1,1,0,0,0-1,1v6A1,1,0,0,0,51,32Zm1-6h4v4H52Z"/><path d="M51,42h6a1,1,0,0,0,1-1V35a1,1,0,0,0-1-1H51a1,1,0,0,0-1,1v6A1,1,0,0,0,51,42Zm1-6h4v4H52Z"/><path d="M51,52h6a1,1,0,0,0,1-1V45a1,1,0,0,0-1-1H51a1,1,0,0,0-1,1v6A1,1,0,0,0,51,52Zm1-6h4v4H52Z"/><path d="M13,24H7a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h6a1,1,0,0,0,1-1V25A1,1,0,0,0,13,24Zm-1,6H8V26h4Z"/><path d="M21,28h4a1,1,0,0,0,1-1V23a1,1,0,0,0-1-1H21a1,1,0,0,0-1,1v4A1,1,0,0,0,21,28Zm1-4h2v2H22Z"/><path d="M34,22H30a1,1,0,0,0-1,1v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V23A1,1,0,0,0,34,22Zm-1,4H31V24h2Z"/><path d="M38,23v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V23a1,1,0,0,0-1-1H39A1,1,0,0,0,38,23Zm2,1h2v2H40Z"/><path d="M21,36h4a1,1,0,0,0,1-1V31a1,1,0,0,0-1-1H21a1,1,0,0,0-1,1v4A1,1,0,0,0,21,36Zm1-4h2v2H22Z"/><path d="M34,30H30a1,1,0,0,0-1,1v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V31A1,1,0,0,0,34,30Zm-1,4H31V32h2Z"/><path d="M43,30H39a1,1,0,0,0-1,1v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V31A1,1,0,0,0,43,30Zm-1,4H40V32h2Z"/><path d="M21,44h4a1,1,0,0,0,1-1V39a1,1,0,0,0-1-1H21a1,1,0,0,0-1,1v4A1,1,0,0,0,21,44Zm1-4h2v2H22Z"/><path d="M34,38H30a1,1,0,0,0-1,1v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V39A1,1,0,0,0,34,38Zm-1,4H31V40h2Z"/><path d="M43,38H39a1,1,0,0,0-1,1v4a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V39A1,1,0,0,0,43,38Zm-1,4H40V40h2Z"/><path d="M13,34H7a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h6a1,1,0,0,0,1-1V35A1,1,0,0,0,13,34Zm-1,6H8V36h4Z"/><path d="M13,44H7a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h6a1,1,0,0,0,1-1V45A1,1,0,0,0,13,44Zm-1,6H8V46h4Z"/><path d="M26,16h3v3a1,1,0,0,0,1,1h4a1,1,0,0,0,1-1V16h3a1,1,0,0,0,1-1V11a1,1,0,0,0-1-1H35V7a1,1,0,0,0-1-1H30a1,1,0,0,0-1,1v3H26a1,1,0,0,0-1,1v4A1,1,0,0,0,26,16Zm1-4h3a1,1,0,0,0,1-1V8h2v3a1,1,0,0,0,1,1h3v2H34a1,1,0,0,0-1,1v3H31V15a1,1,0,0,0-1-1H27Z"/><rect height="2" width="2" x="42" y="56"/><rect height="2" width="2" x="42" y="52"/><rect height="2" width="2" x="42" y="48"/></svg>
                    </label>
                    <input type="text" placeholder="Centre" name="centreC">
                </div>
                <div class="box">
                    <label class="text-avant-input"><svg class="svg-input" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1.5em" height="1.5em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"><g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="16" cy="11" r="4"/><path d="M24 15c-3 7-8 15-8 15s-5-8-8-15s2-13 8-13s11 6 8 13Z"/></g></svg></label>
                    <input type="text" placeholder="Ville ou code postal" name="ville">
            ...
            <div style = "display:none;">
                ...
                while($tuple = $tabmedecin->fetch()){
                    $find=false;
                    foreach($tabspecialite as $valeur) {
                        if($tuple['specialite']==$valeur)
                            $find=true;
                    }
                    if(!$find){
                        $tabspecialite[$i] = $tuple['specialite'];
                        echo $tabspecialite[$i].' ';
                        $i++;
                    }
                }

                echo'<datalist id="spdac">';
                foreach($tabspecialite as $valeur){
            ...
            <div class="content-choice-img"> <img class="textI" src="img/choice.png" id="" alt="" width="150"></div>
        ...
        <div class="hero-right">
            ...
            <div class="contenent-texts">
                <h1 class="titre-center">Bon choix,<br>Meilleur soin</h1>
                <div class="text">
                    <h1>
                        1-A Domicile:
                    </h1>
                    <p>Sans aucun effort de déplacement, nous vous rendons services dans votre lieu de résience</p>
                </div>
                <div class="text">
                    <h1>
                        2-Appel/Video:
                    </h1>
                    <p>Notre consultation prut étre lieu uniquement par teléphone( Appel , audio, vidéo, ...)</p>
                </div>
                <div class="text">
                    <h1>
                        3-Cabinet:
                    </h1>
                    <p>Dés votre arrivée chez notre centres hospitalies, votre consultation sera immédiate</p>
                </div>
            </div>
        </div>
    ...
    <section class="hero-bottom">
        <div class="title">
            <h1>Votre spécialiste de la santé</h1>
            <div class="th">
                <h2 class="h">24h/24</h2>
                <h2 class="j">7j/7</h2>
            </div>
        </div>
        <div class="content12">
        <div class="content1">
            <div class="simplicite">
                <div class="simplicite-content">
                    <div class="img">
                        <img src="img/Simplicité.png" alt="">
                    </div>
                    <h1>Simplicité</h1>
                    <p>N'importe quand, n'importe où</p>
                </div>
            </div>
            <div class="qualite">
                <div class="simplicite-content">
                    <div class="img">
                        <img src="img/convenient.png" alt="">
                    </div>
                    <h1>Qualité</h1>
    ...
    <section class="hero-buttom2">
                <h1>Nos specialitées</h1>
        <div class="content-specialite">
        <div class="content12 con1">
        <div class="content1">
            <div class="simplicite">
                <div class="simplicite-content">
                    <div class="img">
                    ...
                    <h2>Spécialités chirurgicales</h2>
                    <p>Une spécialité chirurgicale désigne une pratique à visée diagnostique ou thérapeutique nécessitant une intervention physique sur le corps humain.</p>
                </div>
            </div>
            <div class="qualite">
                <div class="simplicite-content">
                    ...
                    <h2>Anesthésie-réanimation</h2>
                    <p>l'anesthésie et à la réanimation : prise en charge péri-opératoire (avant, pendant et après l'opération chirurgicale) des patients</p>
                </div>
            </div>
        </div>
        <div class="content2">
            <div class="rapidite">
                <div class="simplicite-content">
                    ...
                    <h2>Médecin générale</h2>
                    <p>La médecine générale, ou médecine familiale, est une spécialité médicale prenant en charge le suivi durable, le bien-être et les soins de santé généraux primaires d'une communauté</p>
                </div>
            </div>
            <div class="securite">
                <div class="simplicite-content">
                    ...
                    <h2>Pédiatrie</h2>
                    <p>Médecin généraliste de l'enfant, le pédiatre veille à sa santé, au bon déroulement de sa croissance et à son développement, physique et mental</p>
                </div>
            </div>
            </div>
        ...
        <div class="content1">
            <div class="simplicite">
                <div class="simplicite-content">
                    ...
                    <h2>Gynécologie médicale</h2>
                    <p>la gynécologie consacrée exclusivement aux affections traitées médicalement : pathologie hormonale, infections génitales, dépistage-prévention des cancers, planification familiale,</p>
                </div>
            </div>
            <div class="qualite">
                <div class="simplicite-content">
                    ...
                    <h2>stomatologie</h2>
                    <p>Spécialité médicale qui se consacre à l'étude des maladies de la cavité buccale ainsi qu'à leur traitement.</p>
                </div>
            </div>
        </div>
        <div class="content2">
            <div class="rapidite">
                <div class="simplicite-content">
                    ...
                    <h2>radiologie</h2>
                    <p>Branche des sciences médicales qui utilise les rayons X à des fins diagnostiques ou thérapeutiques. (La radiologie est l'une des techniques d'imagerie médicale, laquelle comprend également l'échographie</p>
                </div>
            </div>
            <div class="securite">
                <div class="simplicite-content">
                    ...
                    <h2>rhumatologie</h2>
                    <p>la rhumatologie est la spécialité médicale qui prend en charge les douleurs et dysfonctionnements de l'appareil locomoteur et des tissus conjonctifs qui lui sont associés</p>
                </div>
            </div>
            </div>
    ...
    <section class="bar-bottom">
        ...
        <div class="div-list">
            ...
            <ul>
                <li>
                    <a href="loginform.html">Espace Patient</a>
                </li>
                <li>
                    <a href="#">Espace Administratif</a>
                </li>
            </ul>
        </div>
        <div class="div-list">
            ...
            <ul>
                <li>
                    <a href="#">Prendre un render-vous</a>
                </li>
            </ul>
        </div>
        <div class="div-list">
