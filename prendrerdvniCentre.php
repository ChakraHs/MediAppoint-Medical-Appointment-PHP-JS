...
if(!isset($_SESSION['nbpc'])) $_SESSION['nbpc'] = 2;
...
<head>
    ...
    <link rel="stylesheet" href="css/rdvniCentre.css">
    ...
    <script>
        ...
        function conf_paye(){
            var form = document.forms["ttrifpiop"];
        ...
        <div class="rdv-container">
            <div class="rdv-content">
                ...
                <div class="inputs-container">
                    ...
                    <form action="confirmer-rdv-centre.php" method="POST"  name="ttrifpiop">
                        ...
                        <div class="information-container">
                            ...
                            <div class="info-contact-container info-con">
                                ...
                                <div class="deux-inputs Informations-contact">
                                    <div class="input-con">
                                        <input type="email" name="email" id="" placeholder="Email" value="<?php echo $_SESSION['email']; ?>">
                                    </div>
                                    <div class="input-con">
                            ...
                            <div class="info-profil-container info-con">
                                ...
                                <div class = "un-input">
                                    <input type="text" name="nom-utilisateur" id="" placeholder="Nom d'utilisateur" value="<?php echo $_SESSION['username']; ?>">
                                </div>
                                ...
                                <?php
                                    ...
                                    <label for="check2">
                                    <input type='hidden' value='false' name="conditionAccept">
                                    <input type="checkbox" value='true' name="conditionAccept" id="check2" class="check2">
                                    <div>J'ai lu et j'accepte les Conditions Générales d'Utilisation et la Notice d'information et de consentement.</div>
                                    </label>
                                    </div>
